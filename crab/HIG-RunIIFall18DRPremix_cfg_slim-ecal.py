...
# with command line options: step2 --filein step_LHEGSR.root --fileout file:step_aodsim.root --mc --eventcontent AODSIM runUnscheduled --datatier AODSIM --conditions 94X_mc2017_realistic_v10 --step RAW2DIGI,RECO,RECOSIM,EI --nThreads 8 --era Run2_2017 --python_filename HIG-RunIIFall17DRPremix-00086_2_cfg.py --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('RECOslim',eras.Run2_2018)
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_aodsim_slim-ecal.root'),
...
#process.schedule = cms.Schedule(process.hltfilter_step,process.AODSIMoutput_step)
