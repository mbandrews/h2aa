...
# no evt picks, lumimask only: ggNtuples-Era24Sep2020v1_ggSkim-v2
...
# no evt picks, lumimask only: ggNtuples-Era24Sep2020v1_ggSkim-v2
# 2018 units/job = 25, otherwise same as v3
#this_campaign = 'Era2016_06Sep2020_MINIAOD-skimv4'
#this_campaign = 'Era2017_06Sep2020_MINIAOD-skimv4'
#this_campaign = 'Era2018_06Sep2020_MINIAOD-skimv4'

# no evt picks, lumimask only: ggNtuples-Era24Sep2020v1_ggSkim-v2
# 2018 units/job = 15, otherwise same as v3,v4
#this_campaign = 'Era2016_06Sep2020_MINIAOD-skimv5'
#this_campaign = 'Era2017_06Sep2020_MINIAOD-skimv5'
#this_campaign = 'Era2018_06Sep2020_MINIAOD-skimv5'

# no evt picks, lumimask only: ggNtuples-Era24Sep2020v1_ggSkim-v2
# redo v5
#this_campaign = 'Era2016_06Sep2020_MINIAOD-skimv6'
#this_campaign = 'Era2017_06Sep2020_MINIAOD-skimv6'
#this_campaign = 'Era2018_06Sep2020_MINIAOD-skimv6'
...
for s,dset in samples.iteritems(): #python3: samples.items()
    ...
    if 'data2018-Run2018C' not in s: continue
    ...
    for evt_list in evt_lists:
        ...
        with open('crabConfig_skimLumi.py', "r") as template_file:
        ...
        splitting = 'LumiBased'
        if 'data2016' in s:
            job_units = 400 #500 #800
        elif 'data2017' in s:
            job_units = 250 #300 #500
        elif 'data2018' in s:
            job_units = 15 #25 #50
        elif 'h4g' in s:
            job_units = 1000
        ...
        with open('%s/crabConfig_skimLumi_%s.py'%(crab_folder, s), "w") as sample_file:
