...
#campaign = '18Nov2021_AOD-IMGv1' # h4g 2017 LL: do NOT apply HLT dipho trg--applied later using trg SFs instead
#campaign = '18Nov2021_AOD-IMGv2' # add dvtx info
campaign = '18Nov2021_AOD-IMGv3' # fixed tau units
...
eos_basedir['h4g2016'] = '/store/user/mandrews/Run2016/Era2016_%s/hToaaTo4gammaLL'%campaign
eos_basedir['h4g2017'] = '/store/user/mandrews/Run2017/Era2017_%s/hToaaTo4gammaLL'%campaign
eos_basedir['h4g2018'] = '/store/user/mandrews/Run2018/Era2018_%s/hToaaTo4gammaLL'%campaign
