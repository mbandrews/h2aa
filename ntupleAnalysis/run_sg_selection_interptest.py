...
parser.add_argument('-i', '--inlist', default='MAntuples/h4g2017-mA0p4GeV_file_list.txt', type=str, help='Input list of mantuples.')
...
enScale = {'2016': [1.004, 0.978, 1.002],
           '2017': [1.046, 1.032, 1.056],
           '2018': [1.012, 1.018, 1.048],
           }
