...
#cuts = [str(None), 'bdt', 'chgiso', 'phoEta'] # sg sel, post-skim
cuts = [str(None), 'trg', 'npho', 'presel', 'mgg', 'ptomGG', 'bdt', 'chgiso', 'phoEta'] # sg skim+sel
...
for iEvt in range(iEvtStart,iEvtEnd):
    ...
    # Check if in mH-region
    mgg = outvars['mgg'] if 'mgg' in outvars else tree.mgg
    if not in_mh_region(region, mgg): continue
